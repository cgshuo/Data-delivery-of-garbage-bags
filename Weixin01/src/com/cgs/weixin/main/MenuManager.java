...
public class MenuManager {
    ...
    public static void main(String[] args) throws IOException, KeyManagementException, NoSuchAlgorithmException, NoSuchProviderException {
    	...
    	//QRcode.qrcode(t);
        // 第三方用户唯一凭证
        String appId = "wx5af7924025713212";
        // 第三方用户唯一凭证密钥
        String appSecret = "5ba67556fcf8d2d83ed26718426983e8";
    ...
    private static Menu getMenu() {
        ...
        btn11.setName("捐赠书籍");
        btn11.setType("view");
        btn11.setUrl("http://www.cgsgo.com");//("http://702e4e59.ngrok.io/Weixin01/WebContent/qr.png");
